...
(function() {
    ...
    function renderAchievementsPanel() {
        ...
        const isAnonymous = window.Gamification.isAnonymous?.() || !window.SupabaseClient?.getCurrentUser?.();
        const anonName = window.Gamification.getAnonDisplayName?.() || 'Guest';

        // Anonymous user warning/CTA
        const anonWarningHTML = isAnonymous ? `
            <div class="gamify-anon-warning">
                <div class="gamify-anon-info">
                    <span class="gamify-anon-icon">🌊</span>
                    <div class="gamify-anon-text">
                        <strong>Playing as ${anonName}</strong>
                        <span>Sign in with Google to save your progress permanently!</span>
                    </div>
                </div>
                <button class="gamify-signin-btn" id="gamify-signin-btn">
            ...
            <button class="gamify-leaderboard-btn" id="gamify-leaderboard-btn">🏆 View Leaderboard</button>
        ` : '';
        ...
        // Add event handlers for anonymous user buttons
        const signinBtn = document.getElementById('gamify-signin-btn');
        if (signinBtn) {
        ...
        const leaderboardBtn = document.getElementById('gamify-leaderboard-btn');
        if (leaderboardBtn) {
