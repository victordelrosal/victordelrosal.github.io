# Daily AI Intel Scan - Design Document
...
| Component | Details |
|-----------|---------|
| **Name** | Daily AI Intel Scan |
| **URL Pattern** | `/daily-ai-intel-scan-yyyy-mm-dd/` |
...
5:00 AM GMT
    ↓
GitHub Actions triggers daily-ai-intel-scan.yml
    ↓
build-scan.js runs:
...
Trigger build-waves.yml
    ↓
Static page live at /daily-ai-intel-scan-YYYY-MM-DD/
```
...
/.github/workflows/
  daily-ai-intel-scan.yml  # Scheduled workflow

/daily-ai-intel-scan-about/
...
### Output Structure
```
1. HEADLINE: "Daily AI Intel Scan — December 14, 2025"
...
4. TRANSPARENCY FOOTER
   ...
   No human editorial review. [How this works](/daily-ai-intel-scan-about/)"
```
...
```javascript
const scanData = {
  slug: `daily-ai-intel-scan-${dateString}`,
  title: `Daily AI Intel Scan — ${formattedDate}`,
  content: htmlContent,
...
Static page at `/daily-ai-intel-scan-about/` explaining:
